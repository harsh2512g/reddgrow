-- A queued digest still follows the recipient's current organization-local date
-- and preferred send time. Old dates cannot produce a second current-day digest.
