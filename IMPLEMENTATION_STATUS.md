...
- Active branch: main; source release `95f78b0` (`feat: complete ThreadSignal MVP`). The owner performed the push and Vercel deployment attempt. This follow-up fixes repository build configuration; it does not perform a cloud login, migration or deployment.
